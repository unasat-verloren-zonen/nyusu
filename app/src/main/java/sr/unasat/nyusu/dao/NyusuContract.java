...
public class NyusuContract {
    ...
    public static class CurrencyEntry implements BaseColumns {
        ...
        public static final String COLUMN_ID ="currency_id";
        public static final String COLUMN_NAME ="name";
    ...
    public static class MediumEntry implements BaseColumns {
        ...
        public static final String COLUMN_ID = "medium_id";
        public static final String COLUMN_NAME = "name";
    }
    ...
    public static class OilpriceEntry implements BaseColumns {
        ...
        public static final String COLUMN_ID = "oilprice_id";
        public static final String COLUMN_COMPANY_ID = "medium_id";
